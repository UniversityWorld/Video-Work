...
class Mobject(object):
    ...
    def __init__(
        ...
        self.gradient_points = [np.array([0,0,0]), np.array([0,0,0])]
        # Internal state
    ...
    def set_linear_gradient(self, linear_gradient):
        self.gradient_points = linear_gradient
        self.gradient_mode = 1
        self.uniforms["gradient_points"] = [tuple(linear_gradient[i]) for i in range(2)]
